...
gulp.task('build', function() {
    return runSequence('build.clean', ['build.js', 'build.copy.fonts', 'build.copy.images', 'build.copy.server.js', 'build.copy.app', 'build.styles']);
});
...
gulp.task('build.copy.server.js', function() {
